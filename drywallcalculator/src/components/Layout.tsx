    ...
    <div className="min-h-screen bg-slate-50 dark:bg-slate-950 text-slate-900 dark:text-slate-100 transition-colors duration-300">
      ...
      >
        <div className="max-w-5xl mx-auto px-4 sm:px-6 py-8">
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-6 mb-6 text-sm">
            <div>
              <div className="flex items-center gap-2 mb-2 font-semibold text-slate-800 dark:text-slate-200">
                <Layers className="w-4 h-4 text-orange-600" aria-hidden="true" />
                {SITE_NAME}
              </div>
              <p className="text-slate-500 dark:text-slate-400 leading-relaxed">
                Free drywall calculator for walls and ceilings. Sheet counts, waste allowance, and screw estimates for DIY
                projects.
              </p>
            </div>
            <div>
