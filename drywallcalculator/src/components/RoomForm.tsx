...
import type { RoomInput } from '../lib/drywall/types';
        ...
        >
          <div className="flex items-center justify-between gap-2">
            <input
              ...
              className="font-medium bg-transparent border-b border-transparent hover:border-slate-200 dark:hover:border-slate-700 focus:border-orange-500 focus:outline-none px-1 py-0.5 text-sm"
