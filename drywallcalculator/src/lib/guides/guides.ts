    ...
    sections: [
      ...
      },
      {
        ...
        paragraphs: [
          ...
          'Price sheets, mud buckets, and screws in the [drywall cost estimator](/drywall-cost-estimator) after you know hung area so a fourth skim coat shows as materials dollars, not only labor hours.',
        ],
      },
    ],
    faqs: [
    ...
    sections: [
      ...
      },
      {
        ...
        paragraphs: [
          ...
          'Then price those MR planes alone in the [drywall cost estimator](/drywall-cost-estimator) with the green/purple sheet tag so the moisture upgrade is a clear line item versus whole-house standard board.',
        ],
      },
    ],
    faqs: [
      ...
      },
      {
        ...
        answer:
          'For bathrooms with poor ventilation or history of mold, yes. For a powder room with no shower, standard drywall plus good paint is often enough. Compare sheet tags in the [drywall cost estimator](/drywall-cost-estimator) before upgrading every plane.',
      },
      {
    ...
    sections: [
      ...
      },
      {
        ...
        paragraphs: [
          ...
          'Price the doubled board (and extra mud/screws) in the [drywall cost estimator](/drywall-cost-estimator) so the STC upgrade is a clear materials delta versus a single-layer wall.',
        ],
      },
    ],
    faqs: [
      {
        ...
        answer:
          'One specialty board helps modestly — STC gains of a few points. Best results combine mass, insulation, sealing, and often double layers or decoupling. Compare sheet counts twice in the [drywall cost estimator](/drywall-cost-estimator) before buying specialty board for every plane.',
      },
      {
