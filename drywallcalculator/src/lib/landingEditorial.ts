...
export const LANDING_EDITORIAL: Record<string, LandingEditorial> = {
  ...
  'drywall-cost-estimator': {
    ...
    sections: [
      ...
      {
        heading: 'Garage fire walls as a separate materials line',
        paragraphs: [
          'Attached-garage separation often needs Type X on shared walls and ceilings under living space — not every exterior garage wall. Measure those planes alone, then price Type X sheets, mud, and screws here so the fire upgrade does not get buried in a whole-garage sheet guess.',
          'Code and thickness notes: [garage drywall fire separation](/guides/garage-drywall-fire-separation). Sheet counts for non-rated walls still belong in the main [drywall calculator](/drywall-calculator).',
        ],
      },
      {
        heading: 'Level 5 skim as materials dollars',
        paragraphs: [
          'Critical lighting and gloss paint push finish toward Level 5 — that is extra mud volume and sanding, not a free upgrade on the same Level 4 cart. Price sheets and screws for the hung area first, then add mud buckets for the skim so DIY vs pro quotes cannot hide the finish level inside a vague labor number.',
          'Finish intent: [drywall finish levels](/guides/drywall-finish-levels-explained). Coat counts: [how many coats of mud](/guides/how-many-coats-drywall-mud).',
        ],
      },
      {
        heading: 'Green/purple board only where moisture warrants it',
        paragraphs: [
          'Whole-house mold-resistant board inflates the materials total without helping dry bedrooms. Measure bathroom (and other damp) planes alone, swap the sheet price field to the green or purple tag, and keep standard board elsewhere so the moisture upgrade stays a clear line item.',
          'Product choice: [green board vs purple board for bathrooms](/guides/green-board-purple-board-bathrooms). Sheet counts still start in the [drywall calculator](/drywall-calculator).',
        ],
      },
      {
        heading: 'Vaulted and cathedral ceilings as materials dollars',
        paragraphs: [
          'A vaulted great-room ceiling is not the same buy as a flat bedroom rectangle — slope length, ridge cuts, and wasted triangles push both sheet count and waste percentage up. Measure each plane (or average height carefully), start waste at 12–15%, then price sheets, mud, and screws here so the cathedral upgrade shows as board dollars before labor.',
          'Get ceiling sheet count from the [ceiling drywall calculator](/drywall-for-ceiling-calculator), hang notes in [hanging drywall on a ceiling](/guides/hanging-drywall-on-ceiling), and keep wall planes in the main [drywall calculator](/drywall-calculator) if you are buying walls and ceiling as separate carts.',
        ],
      },
    ],
  },
