...
export const LANDING_PAGES: LandingPage[] = [
  ...
  },
  {
    ...
    faqs: [
      ...
      {
        question: 'How much do vaulted or cathedral ceilings add to drywall materials cost?',
        answer:
          'Vaulted and cathedral ceilings add more board area than a flat length × width rectangle, plus higher waste (often 12–15%) for angles, ridge cuts, and hard-to-reuse scraps. Measure each sloped plane or use average height carefully, bump waste, then price sheets, mud, and screws here after a sheet count from the [ceiling drywall calculator](/drywall-for-ceiling-calculator) — see [hanging drywall on a ceiling](/guides/hanging-drywall-on-ceiling).',
      },
    ],
  },
];
