...
const HOMEPAGE_FAQ = [
  ...
  {
    q: 'How much do vaulted ceilings add to drywall cost?',
    a: 'Vaulted and cathedral ceilings need more board area and often 12–15% waste for angled cuts. Estimate ceiling sheets first, then price panels, mud, and screws in the [drywall cost estimator](/drywall-cost-estimator).',
  },
  {
