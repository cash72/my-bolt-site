...
export default function TermsPage() {
  ...
  return (
    <LegalPageLayout title="Terms of Use">
      ...
      <p>
        {SITE_NAME} offers free drywall calculators for sheets, waste, screws, mud, and project guides for rooms, ceilings, and garages. Content is for general information and estimating only.
      </p>
