    ...
    sections: [
      ...
      },
      {
        ...
        paragraphs: [
          ...
          'Price that higher buy area in the [flooring cost estimator](/flooring-cost-estimator) so 20% waste shows as dollars before you commit to a large-format SKU.',
        ],
      },
      {
