...
export const LANDING_EDITORIAL: Record<string, LandingEditorial> = {
  ...
  'flooring-cost-estimator': {
    ...
    sections: [
      ...
      {
        heading: 'Open-concept continuous floors and dye lots',
        paragraphs: [
          'When living, dining, and kitchen share one continuous floor, treat them as one buy — not three separate aisle trips. Sum the open planes, apply one waste %, and run a single materials + optional install total here so dye lots stay consistent from entry to island.',
          'Example: 18×22 living + 12×14 dining opening = 564 sq ft + 10% waste ≈ 620 sq ft to buy. At $3.25/sq ft materials ≈ $2,015 before underlay and trim. Confirm carton count with [how many flooring boxes](/how-many-flooring-boxes), and keep transitions only where height or material actually changes — see [flooring transitions and trim](/guides/flooring-transition-strips-and-trim).',
        ],
      },
    ],
  },
