...
export const LANDING_PAGES: LandingPage[] = [
  ...
  },
  {
    ...
    faqs: [
      ...
      {
        question: 'Should open-concept rooms share one continuous flooring buy for dye-lot matching?',
        answer:
          'Yes when living, dining, and kitchen share one continuous floor — buy one SKU and one dye lot for the combined square footage so later cartons do not shift shade. Sum every open plane, apply one waste %, and run a single materials total here; convert to cartons with [how many flooring boxes](/how-many-flooring-boxes). Closets off the open plan can use leftovers from the same lot.',
      },
    ],
    relatedGuideSlugs: [
