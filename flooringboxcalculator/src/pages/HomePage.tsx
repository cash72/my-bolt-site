...
const HOMEPAGE_FAQS = [
  ...
  {
    question: 'Should open-concept rooms share one flooring buy?',
    answer:
      'Yes when living, dining, and kitchen share one continuous floor — buy one SKU and dye lot for the combined area. Sum the open planes in the [flooring cost estimator](/flooring-cost-estimator), then convert to cartons with [how many flooring boxes](/how-many-flooring-boxes).',
  },
  {
