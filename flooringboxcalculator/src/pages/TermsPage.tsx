...
export default function TermsPage() {
  ...
  return (
    <LegalPageLayout title="Terms of Use">
      ...
      <p>
        {SITE_NAME} offers free flooring calculators (boxes, square footage, waste) and DIY installation guides for laminate, tile, carpet, and LVP. Content is for general information and estimating only.
      </p>
