...
import { Moon, Thermometer, Sun } from 'lucide-react';
        ...
        <div className="max-w-5xl mx-auto px-4 sm:px-6 h-14 flex items-center justify-between gap-4">
          <Link to="/" className="flex items-center gap-2.5 shrink-0">
            <div className="w-8 h-8 rounded-lg bg-sky-600 flex items-center justify-center">
              <Thermometer className="w-5 h-5 text-white" aria-hidden="true" />
            </div>
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6 mb-6 text-sm">
            ...
            <div>
              ...
              <ul className="flex flex-col gap-2 max-h-48 overflow-y-auto">
                ...
                <li>
                  <Link to="/guides" className="text-sky-600 dark:text-sky-400 hover:underline text-xs font-medium">
                    View all guides →
                  </Link>
                </li>
              </ul>
