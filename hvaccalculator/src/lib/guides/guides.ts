...
export const GUIDES: Guide[] = [
    ...
    sections: [
      ...
      },
      {
        ...
        paragraphs: [
          ...
          'Once capacity and SEER are set, estimate shore-power electricity with the [AC cost to run calculator](/ac-cost-to-run-calculator) — full-timers often run 10+ hours/day in hot parks.',
        ],
      },
    ],
    faqs: [
  ...
  },
  {
    ...
    faqs: [
      ...
      {
        question: 'Does an oversized mini-split cost more to run?',
        answer:
          'Often yes on real bills — short cycles, poor humidity control, and “just in case” tonnage all raise kWh versus a right-sized head at the same SEER. After you correct capacity in the [mini-split calculator](/mini-split-calculator), compare monthly electricity in the [AC cost to run calculator](/ac-cost-to-run-calculator) before you pay for an extra half-ton.',
      },
    ],
  },
  {
  ...
  },
  {
    ...
    sections: [
      ...
      {
        heading: 'Cooling-mode electricity: heat pump vs AC',
        paragraphs: [
          'In cooling mode, a heat pump and a cooling-only AC with the same SEER/SEER2 and capacity use roughly the same compressor energy for the same hours. The bill difference shows up in winter (HSPF/backup heat) and in how many hours you actually run — not in a magic “heat pump discount” on July afternoons.',
          'Compare two SEER labels with your real summer hours in the [AC cost to run calculator](/ac-cost-to-run-calculator) before you pay a heat-pump premium solely for cooling savings.',
        ],
      },
    ],
    faqs: [
      ...
      {
        question: 'Do heat pumps cost less to cool than an AC?',
        answer:
          'Not automatically. Matching SEER/SEER2 and BTU means similar cooling kWh for the same hours. Use the [AC cost to run calculator](/ac-cost-to-run-calculator) with both labels; heat-pump value is usually the heating season, not a free cooler summer bill.',
      },
    ],
  },
  {
    ...
    sections: [
      ...
      },
      {
        ...
        paragraphs: [
          ...
          'Before you rent or buy a portable for another humid September, compare monthly kWh against a window unit (or a small ductless head) in the [AC cost to run calculator](/ac-cost-to-run-calculator) using each label’s SEER/EER and your real hours.',
        ],
      },
    ],
    faqs: [
      ...
      {
        question: 'How much more does a portable AC cost to run than a window unit?',
        answer:
          'Single-hose portables often need more runtime (and sometimes higher nominal BTU) for the same room, so monthly kWh runs higher than a similar-BTU window unit. Plug both SEER/EER ratings and your hours into the [AC cost to run calculator](/ac-cost-to-run-calculator) — the gap is usually hours × efficiency, not the brand name.',
      },
    ],
  },
  {
    ...
    sections: [
      ...
      },
      {
        ...
        paragraphs: [
          ...
          'Before you wire a premium SEER tier, estimate recovery with the [AC cost to run calculator](/ac-cost-to-run-calculator) using your climate hours and utility rate.',
        ],
      },
    ],
    faqs: [
    ...
    sections: [
      ...
      },
      {
        ...
        paragraphs: [
          ...
          'Restricted outdoor airflow and long line sets also raise real-world kWh — after you lock capacity, compare SEER tiers with the [AC cost to run calculator](/ac-cost-to-run-calculator).',
        ],
      },
    ],
    faqs: [
  ...
  },
  {
    ...
    sections: [
      ...
      },
      {
        ...
        paragraphs: [
          ...
          'Before you pay for the highest SEER kit SKU, estimate monthly electricity with the [AC cost to run calculator](/ac-cost-to-run-calculator) using your climate hours and utility rate.',
        ],
      },
      {
    ...
    faqs: [
      ...
      },
      {
        ...
        answer:
          'Look at SEER2/HSPF2 on the sheet, not marketing. Mid-tier DIY kits can be efficient when sized and installed correctly — see [SEER ratings explained](/guides/seer-ratings-explained), then plug both SEER numbers into the [AC cost to run calculator](/ac-cost-to-run-calculator) with your hours and $/kWh.',
      },
    ],
  },
  {
    ...
    faqs: [
      ...
      {
        question: 'Should I let the installer pick the highest SEER?',
        answer:
          'Not blindly. Ask for two SEER2 options at the same capacity, then compare monthly electricity in the [AC cost to run calculator](/ac-cost-to-run-calculator) with your climate hours and $/kWh — pay for efficiency you will recover, not the top SKU by default.',
      },
    ],
  },
  {
    ...
    faqs: [
      ...
      {
        question: 'Are clearance window ACs cheap to run?',
        answer:
          'Often not — end-of-season units can be low-SEER. Before you mount another season of cooling, compare the label SEER against a higher-efficiency option in the [AC cost to run calculator](/ac-cost-to-run-calculator) with your overnight and afternoon hours.',
      },
    ],
  },
];
