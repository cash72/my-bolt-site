...
export const LANDING_PAGES: LandingPage[] = [
  ...
  },
  {
    ...
    faqs: [
      ...
      {
        question: 'How do time-of-use rates change AC cost to run?',
        answer:
          'On TOU plans, afternoon peak $/kWh can be 2–3× the overnight rate. Enter the rate you actually pay during the hours the compressor runs — not the average blended bill rate. A SEER 14 unit on expensive peak kWh can cost more than a SEER 20 unit on the same hours; use the compare field above with your peak rate and a realistic 10–14 hour peak-summer day.',
      },
      {
        question: 'How much does a 1.5 ton (18,000 BTU) AC cost to run?',
        answer:
          '1.5 tons = 18,000 BTU/hr. At SEER 16, 8 hours/day, and $0.15/kWh, planning math is about 9 kWh/day (~$1.35/day or ~$40/month). The same load at SEER 22 drops closer to ~6.5 kWh/day (~$30/month). Enter 18,000 BTU (or 1.5 tons), your SEER/SEER2, hours, and rate above — then compare a second SEER before you upsize from a 1-ton head “just in case.”',
      },
      {
        question: 'Does raising the thermostat a few degrees cut AC cost?',
        answer:
          'Yes — higher setpoints usually mean fewer compressor hours, which cuts kWh more reliably than chasing a small SEER bump on an already-efficient unit. Model your real hours at the temperature you actually keep (not the coldest afternoon), then use the compare field to see whether a SEER upgrade or a 2–3°F setback saves more on your rate. Fan-only or dry mode still uses some power but far less than continuous cool.',
      },
    ],
  },
];
