              ...
              <li key={guide.slug}>
                <div className="rounded-xl border border-slate-200 dark:border-slate-800 bg-white dark:bg-slate-900 px-4 py-3">
                  <Link
                    ...
                    className="block text-sm font-medium hover:text-sky-700 dark:hover:text-sky-400 transition-colors"
                  >
                    {guide.title}
                  </Link>
                  {guide.toolPath && guide.toolLabel && (
                    <Link
                      to={guide.toolPath}
                      className="mt-1 block text-xs font-medium text-sky-600 dark:text-sky-400 hover:underline"
                    >
                      {guide.toolLabel} →
                    </Link>
                  )}
          ...
          <ul className="grid grid-cols-1 sm:grid-cols-2 gap-3">
            {relatedPages.map((related) => (
              <li key={related.slug}>
                <Link
                  to={related.path}
                  className="block rounded-xl border border-slate-200 dark:border-slate-800 bg-white dark:bg-slate-900 px-4 py-3 text-sm font-medium hover:border-sky-300 dark:hover:border-sky-700 transition-colors"
                >
