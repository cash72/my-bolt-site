  ...
  return (
    <LegalPageLayout title="Privacy Policy">
      ...
      <p>
        ...
        our BTU and mini-split calculators, and how advertising partners may use cookies when ads are enabled.
      </p>

      <h2 className="text-xl font-semibold text-slate-800 dark:text-slate-200">Information you enter in tools</h2>
      <p>
        Space dimensions, insulation, and climate settings you type into calculators are processed in your browser. We do not require an account and we do not intentionally store
