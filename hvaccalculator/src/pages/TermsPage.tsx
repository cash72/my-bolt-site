...
export default function TermsPage() {
  ...
  return (
    <LegalPageLayout title="Terms of Use">
      ...
      <p>
        {SITE_NAME} offers free BTU, mini-split, and room AC sizing calculators plus HVAC education guides for homes, RVs, garages, and cottages. Content is for general information and estimating only.
      </p>
