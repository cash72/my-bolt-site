...
export const COMPARISONS: ComparisonPage[] = [
  {
    ...
    sections: [
      ...
      {
        heading: 'Fall cleanup and leaf-season crew seats',
        paragraphs: [
          'September–November leaf cleanup, gutter add-ons, and one-time bed cutbacks spike temporary helpers. Price software seats for the peak crew you actually schedule — not just your summer mowing headcount — so Jobber or Housecall Pro does not surprise you mid-season.',
          'If fall work is mostly flat-rate day jobs with online booking and card-on-file, Housecall Pro’s payment stack earns its keep; if your loop is still quote → route → invoice for recurring clients, Jobber usually stays simpler. Confirm current tier dollars on the [pricing matrix](/pricing).',
        ],
      },
    ],
    faqs: [
      ...
      {
        question: 'Do I need more Jobber or Housecall Pro seats for fall leaf cleanup?',
        answer:
          'Often yes for a few months — seasonal helpers who need the mobile app usually count as billable users. Model peak fall headcount (not summer-only) on the [pricing matrix](/pricing) before you lock an annual plan, then drop seats after leaf season if your vendor allows mid-term changes.',
      },
    ],
  },
  {
