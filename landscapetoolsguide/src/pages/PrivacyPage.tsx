  ...
  return (
    <LegalPageLayout title="Privacy Policy">
      ...
      <p>
        ...
        our landscaping software comparisons and guides, and how advertising partners may use cookies when ads are enabled.
      </p>

      <h2 className="text-xl font-semibold text-slate-900 dark:text-slate-100">Information we collect</h2>
      <p>
        You can browse this directory without an account. We do not intentionally store personal form data on our
        servers. Hosting logs and advertising cookies are described below.
      </p>

      <h2 className="text-xl font-semibold text-slate-900 dark:text-slate-100">Hosting data</h2>
      <p>
      ...
      <h2 className="text-xl font-semibold text-slate-900 dark:text-slate-100">Google AdSense and advertising</h2>
      <p>
      ...
      <h2 className="text-xl font-semibold text-slate-900 dark:text-slate-100">Third-party links</h2>
      <p>
        Outbound links to software vendors have their own privacy policies. We are not responsible for third-party
        sites.
      </p>

      <h2 className="text-xl font-semibold text-slate-900 dark:text-slate-100">Email you send us</h2>
      <p>
      ...
      <h2 className="text-xl font-semibold text-slate-900 dark:text-slate-100">Changes</h2>
      <p>
