...
export default function TermsPage() {
  ...
  return (
    <LegalPageLayout title="Terms of Use">
      ...
      <p>
        {SITE_NAME} offers independent landscaping and lawn-care software comparisons, checklists, and buying guides for small field-service businesses. Content is for general information and estimating only.
      </p>
