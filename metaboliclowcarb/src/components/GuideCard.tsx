  ...
  return (
    <div className="h-full flex flex-col rounded-xl border border-slate-200 dark:border-slate-800 bg-white dark:bg-slate-900/50 overflow-hidden">
      <Link
        ...
        className="block flex-1 p-5 hover:bg-teal-50/50 dark:hover:bg-teal-950/20 transition-colors"
      >
        ...
        <p className="text-xs text-slate-500 dark:text-slate-500">{guide.readMinutes} min read</p>
      </Link>
