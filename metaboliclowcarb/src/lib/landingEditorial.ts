...
export const LANDING_EDITORIAL: Record<string, LandingEditorial> = {
  ...
  'keto-macro-calculator': {
    ...
    sections: [
      ...
      {
        heading: 'Desk days vs training days',
        paragraphs: [
          'A sedentary desk week and a lifting block rarely share the same calorie budget. Keep protein and ~20g net carbs steady; let fat fill what remains after you refresh activity in the [TDEE calorie calculator](/tdee-calorie-calculator).',
          'Do not “eat back” every workout snack by default — verify packaged carbs with the [net carb calculator](/net-carb-calculator) and re-run macros here after the new TDEE prints.',
        ],
      },
      {
        heading: 'Label math keeps the 20g ceiling honest',
        paragraphs: [
          'Daily macros fail when sauces and “keto” snacks hide fiber and sugar-alcohol math. Check each packaged serving in the [net carb calculator](/net-carb-calculator), then spend the remaining grams on whole-food meals that still hit protein from this page.',
          'If label surprises keep blowing the budget, tighten brands before you slash fat or calories — refresh the ceiling with [TDEE](/tdee-calorie-calculator) only after adherence is clean for a week.',
        ],
      },
      {
        heading: 'Restaurant nights without abandoning the split',
        paragraphs: [
          'Build the plate around protein and non-starchy vegetables first; ask for sauces on the side and skip bread baskets. Use fat for satiety only if you still have room under the calorie ceiling from this page — you do not have to finish every fat gram.',
          'If dinner was larger than planned, return to normal macros tomorrow. Refresh the budget with the [TDEE calorie calculator](/tdee-calorie-calculator) only after a 2–3 week average stalls — not after a single meal out.',
        ],
      },
      {
        heading: 'Rest days and fat ceilings',
        paragraphs: [
          'On rest or desk-heavy days, keep protein and ~20g net carbs from this calculator; let fat float down with the lower calorie budget. Refresh activity in the [TDEE calorie calculator](/tdee-calorie-calculator), then re-run macros here so leftover calories match the quieter day.',
          'Forcing every fat gram on a rest day is a common stall. Verify packaged carbs with the [net carb calculator](/net-carb-calculator) before you blame the macro split.',
        ],
      },
      {
  ...
  'tdee-calorie-calculator': {
    ...
    sections: [
      ...
      {
        heading: 'Recheck after training or desk-job changes',
        paragraphs: [
          'Starting a lifting block or moving to a sedentary job changes burn more than day-to-day scale noise. Bump or drop the activity multiplier here, wait 2–3 weeks, then rebuild protein and ~20g net carbs in the [keto macro calculator](/keto-macro-calculator).',
          'Still stalling after the activity update? Prefer a modest 300–500 calorie deficit over crash cuts, and verify packaged carbs with the [net carb calculator](/net-carb-calculator).',
        ],
      },
      {
        heading: 'Trust weekly averages, not one weigh-in',
        paragraphs: [
          'Sodium, glycogen, and meal timing can swing the scale 2–4 lb overnight without changing fat mass. Average morning weights for a week before you cut another 500 calories.',
          'If the weekly average is flat, trim 300–500 from this TDEE (or hold if hunger is high), then refresh the split in the [keto macro calculator](/keto-macro-calculator) so protein stays locked.',
        ],
      },
      {
        heading: 'Weekly weigh-ins vs weekly TDEE recalcs',
        paragraphs: [
          'Weigh often; recalculate TDEE sparingly. Re-run this page after a lasting activity change or a 10–15 lb shift — not every Monday just because the calendar turned.',
          'Between recalcs, use the weekly average to decide hold vs a modest 300–500 calorie cut, then keep macros current in the [keto macro calculator](/keto-macro-calculator).',
        ],
      },
      {
        heading: 'Travel and holiday weeks',
        paragraphs: [
          'One messy week rarely needs a new TDEE. Keep protein and ~20g net carbs from the [keto macro calculator](/keto-macro-calculator) as the guardrails, then use the next full week of morning averages before you cut another 500 calories.',
          'If walking dropped for good (new desk job, injury), update the activity factor here once — then rebuild macros so fat grams match the lower burn instead of “punishing” a vacation.',
        ],
      },
      {
        heading: 'Step-count weeks vs gym blocks',
        paragraphs: [
          'Consistent 8–10k daily steps often belong in lightly active — not sedentary — but only if that walking is most days, not a one-off weekend. Start one notch lower if you are unsure, then bump activity here after 2–3 weeks of weekly averages.',
          'When you change the multiplier, rebuild protein and ~20g net carbs in the [keto macro calculator](/keto-macro-calculator) so fat grams match the new ceiling instead of an old gym-block estimate.',
        ],
      },
      {
