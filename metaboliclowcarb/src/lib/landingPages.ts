...
export const LANDING_PAGES: LandingPage[] = [
  ...
  },
  {
    ...
    title: 'Free Keto Macro Calculator — Daily Protein, Fat & 20g Net Carbs',
    h1: 'Free Keto Macro Calculator',
    description:
      'Free keto macro calculator: daily protein, fat, and ~20g net carbs from age, weight, height, and activity. Pair with TDEE when the scale stalls. No signup.',
    ...
    faqs: [
      ...
      {
        question: 'How do I hit keto macros when eating out?',
        answer:
          'Order protein + non-starchy vegetables first, skip sugary sauces, and treat fat as optional for satiety — not a requirement to finish. Keep your day ceiling from this calculator; if portions were larger than planned, refresh calories with the [TDEE calorie calculator](/tdee-calorie-calculator) the next morning instead of “making up” with a crash day.',
      },
      {
        question: 'Do I need to hit fat grams on rest days?',
        answer:
          'No — protein and ~20g net carbs stay the priority; fat is a flexible ceiling for satiety. On rest or desk days, refresh activity in the [TDEE calorie calculator](/tdee-calorie-calculator), then re-run this keto macro calculator so leftover calories (and fat grams) match the lower burn instead of forcing day-one fat targets.',
      },
      {
  ...
  },
  {
    ...
    tool: 'tdee',
    title: 'Free TDEE Calorie Calculator — Daily Calories, BMR & Deficit',
    h1: 'Free TDEE Calorie Calculator',
    description:
      'Free TDEE calorie calculator (Mifflin-St Jeor): BMR, maintenance calories, and an optional 300–500 calorie deficit — then pair with the keto macro calculator. No signup.',
    ...
    faqs: [
      ...
      {
        question: 'Should I change TDEE after a travel or holiday week?',
        answer:
          'Only if activity or body weight actually shifted — not because one week felt messy. Average the next full week of morning weights; if the trend is up or flat for 2–3 weeks, re-run this TDEE with your current activity, then rebuild protein and ~20g net carbs in the [keto macro calculator](/keto-macro-calculator).',
      },
      {
        question: 'Should I pick lightly active if I walk 8–10k steps?',
        answer:
          'Often yes if those steps are consistent most days — sedentary usually means desk work with little walking. If you are unsure, start one notch lower, track a weekly average weight for 2–3 weeks, then bump activity here only if the trend keeps dropping faster than planned. Rebuild protein and ~20g net carbs in the [keto macro calculator](/keto-macro-calculator) after any lasting activity change.',
      },
    ],
    relatedGuideSlugs: [
