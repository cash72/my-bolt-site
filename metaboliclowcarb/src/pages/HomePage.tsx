...
const HOMEPAGE_FAQS = [
  ...
  {
    question: 'What if my weekly average stalls after eating out?',
    answer:
      'One restaurant night rarely needs new numbers. Keep protein and ~20g net carbs from the [keto macro calculator](/keto-macro-calculator), average the next full week of morning weights, then refresh calories with the [TDEE calorie calculator](/tdee-calorie-calculator) only if the trend is flat for 2–3 weeks.',
  },
];
...
export default function HomePage() {
  ...
  usePageMeta({
    title: 'Free Keto Macro & TDEE Calculator — Protein, Fat & Daily Calories',
    description:
      'Free keto macro calculator (~20g net carbs) and free TDEE calorie calculator: protein, fat, BMR, and deficit targets. Plus net carb label math — no signup.',
    path: '/',
  });
      ...
      <div className="space-y-6">
        <div>
          ...
          <p className="text-slate-600 dark:text-slate-400 text-sm sm:text-base">
            Free keto macro (~20g net carbs) and TDEE calorie tools first — then net carb label math and a fasting
            clock when you are ready. Educational estimates only; not medical advice.
          </p>
        </div>
