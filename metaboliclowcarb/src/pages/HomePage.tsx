...
export default function HomePage() {
  ...
  usePageMeta({
    ...
    description:
      'Free keto macro calculator (~20g net carbs) and TDEE calorie calculator: daily protein, fat, BMR, and deficit targets. Plus net carb label math and fasting clock — no signup.',
    path: '/',
  });
