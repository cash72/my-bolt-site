...
export default function PrivacyPage() {
  usePageMeta({
    ...
    description: `Privacy policy for ${SITE_NAME} — calculators, cookies, analytics, and Google AdSense disclosures.`,
    path: '/privacy',
  });
  ...
  return (
    <LegalPageLayout title="Privacy Policy">
      ...
      <p>
        Food label values, body stats, and fasting times you type into calculators are processed in your browser for the
        calculation. We do not require an account and we do not intentionally store your personal calculator inputs on
      ...
      <p>
        ...
        sensitive medical records or passwords.
      </p>
