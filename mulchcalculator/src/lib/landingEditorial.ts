    ...
    sections: [
      ...
      },
      {
        ...
        paragraphs: [
          ...
          'Labor Day weekend window: if bulk delivery is already booked through mid-week, price bags here for any job under ~1.5 yards and finish curb-appeal beds before September wait lists stretch. When a yard still has a Saturday/Monday drop slot, lock materials dollars above first so you are not negotiating volume on the phone.',
