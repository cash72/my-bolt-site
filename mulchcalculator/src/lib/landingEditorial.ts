    ...
    sections: [
      ...
      },
      {
        ...
        paragraphs: [
          ...
          'Depth and timing tips live in [fall mulch application timing](/guides/fall-mulch-application-timing) and [spring mulch application](/guides/spring-mulch-application-guide) — use this estimator for the dollar side of the same bed measurements.',
        ],
      },
      {
