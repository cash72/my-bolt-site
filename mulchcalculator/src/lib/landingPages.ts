...
export const LANDING_PAGES: LandingPage[] = [
  ...
  },
  {
    ...
    description:
      'How much does mulch cost? Estimate bulk cubic-yard vs bagged mulch for Labor Day weekend bag runs or early-fall delivery — free materials cost calculator before wait lists stack up.',
    breadcrumbLabel: 'Cost estimator',
    intro:
      'Enter bed dimensions and depth, then optional prices per cubic yard and per 2 cu ft bag. Compare bulk delivery vs bagged mulch before you order — useful for Labor Day weekend bag runs when trucks are booked out.',
    faqs: [
      {
      ...
      {
        question: 'What if I wait until after Labor Day to order mulch?',
        answer:
          'You can — but mid-September often means longer delivery lead times as yards stack fall bed refreshes, not necessarily higher $/yard. If you wait, still measure now and run bulk vs bags here so you can call with a locked materials total when a drop date opens. Same-day bag runs from big-box remain the backup when trucks are booked out.',
      },
      {
        question: 'Is Labor Day weekend a good time to buy bagged mulch?',
        answer:
          'Often yes for under ~1.5 yards: holiday big-box promotions and empty parking lots make bag runs easier than waiting on bulk delivery. Enter your yardage and local bag price above — if bags land within ~20% of bulk-plus-delivery, skip the truck and finish the beds this weekend. Depth tips: [fall mulch application timing](/guides/fall-mulch-application-timing).',
      },
    ],
  },
  {
