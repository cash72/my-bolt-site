...
const HOMEPAGE_FAQ = [
  ...
  },
  {
    ...
    a: 'Yes. Add up to five beds and the calculator totals area, volume, and bags for the whole project — useful before Labor Day when combining front and back beds into one bulk order often beats separate bag runs. Price the combined total in the [bulk / bag cost estimator](/mulch-cost-estimator).',
  },
  {
    q: 'Should I bag-run mulch over Labor Day weekend?',
    a: 'If you are under ~1.5 cubic yards and bulk delivery is booked out, holiday bag runs often finish the job faster than waiting on a mid-September drop. Run bag vs bulk dollars in the [bulk / bag cost estimator](/mulch-cost-estimator) with your local tags before you fill the trunk.',
  },
] as const;
...
export default function HomePage() {
  usePageMeta({
    ...
    description:
      'Free mulch cost estimator and cubic-yard calculator. Compare bulk $/yard vs bagged mulch for Labor Day weekend bag runs or early-fall delivery — lock materials totals before wait lists stack up.',
    path: '/',
  });
