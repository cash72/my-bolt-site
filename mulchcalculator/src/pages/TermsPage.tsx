...
export default function TermsPage() {
  ...
  return (
    <LegalPageLayout title="Terms of Use">
      ...
      <p>
        {SITE_NAME} offers free mulch, gravel, topsoil, and sod calculators plus outdoor project guides for beds, coverage, and material ordering. Content is for general information and estimating only.
      </p>
