        ...
        <div className="max-w-5xl mx-auto px-4 sm:px-6 h-14 flex items-center justify-between gap-4">
          <Link to="/" className="flex items-center gap-2.5 shrink-0">
            <div className="w-8 h-8 rounded-lg bg-blue-600 flex items-center justify-center">
              <Paintbrush className="w-5 h-5 text-white" aria-hidden="true" />
            </div>
        ...
        <div className="max-w-5xl mx-auto px-4 sm:px-6 py-8">
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6 mb-6 text-sm">
            <div>
              <div className="flex items-center gap-2 mb-2 font-semibold text-slate-800 dark:text-slate-200">
                <Paintbrush className="w-4 h-4 text-blue-600" aria-hidden="true" />
                {SITE_NAME}
              </div>
              <p className="text-slate-500 dark:text-slate-400 leading-relaxed">
                Free paint, stain, and wallpaper calculators plus DIY guides for coverage, coats, and gallon counts.
              </p>
            </div>
            <div>
            ...
            <div>
              ...
              <ul className="flex flex-col gap-2 max-h-48 overflow-y-auto">
                ...
                <li>
                  <Link to="/guides" className="text-blue-600 dark:text-blue-400 hover:underline text-xs font-medium">
                    View all guides →
                  </Link>
                </li>
              </ul>
          ...
          <div className="pt-6 border-t border-slate-100 dark:border-slate-800 flex flex-col sm:flex-row items-center justify-between gap-3 text-sm text-slate-500 dark:text-slate-400">
            <p className="text-center sm:text-left">
              Estimates only — verify before you buy.{' '}
