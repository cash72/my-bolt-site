    ...
    faqs: [
      {
        ...
        answer:
          'Most interior latex covers 350–400 sq ft per gallon on smooth, primed walls for one coat. Two coats means dividing your total area by a lower effective rate — many DIYers plan 300–350 sq ft per gallon per coat in practice. Convert your exact can rate in the [Behr paint coverage calculator](/paint-coverage-calculator).',
      },
      {
        question: 'Is 400 sq ft per gallon realistic?',
        answer:
          'On smooth, primed drywall with a quality roller and one coat — yes, for many premium paints. Real-world DIY projects with two coats plan closer to 350 sq ft per gallon per coat. Enter 350 in the [coverage calculator](/paint-coverage-calculator) when walls are textured.',
      },
      {
        question: 'What is Behr paint coverage per gallon?',
        answer:
          'Check your specific Behr product label. Premium Plus Interior often lists up to 400 sq ft/gallon on ideal surfaces; primer and exterior lines are lower. Enter that number in our [Behr paint coverage calculator](/paint-coverage-calculator) with your room size for gallons to buy.',
      },
      {
        question: 'How much Behr paint do I need?',
        answer:
          'A 12×12 room with 8 ft ceilings is about 384 sq ft of walls. Two coats at Behr’s ~400 sq ft/gallon rate ≈ 1.9 gallons — buy 2–3 gallons depending on texture and colour change. Use the [Behr paint coverage calculator](/paint-coverage-calculator) or [how much Behr paint calculator](/how-much-paint-do-i-need) with your room size and can label.',
      },
      {
        question: 'Does Behr have an online paint calculator?',
        answer:
          'Behr focuses on product specs and colour tools rather than a room gallon estimator. Use our free [Behr paint coverage calculator](/paint-coverage-calculator) with your wall measurements and the sq ft/gallon from your Behr can — the math is the same for any brand.',
      },
      {
        question: 'How do I convert a per-litre Behr label to gallons?',
        answer:
          '1 US gallon ≈ 3.785 L and 1 m² ≈ 10.764 sq ft. Example: 10 m²/L ≈ 407 sq ft/gallon — enter that in the [coverage calculator](/paint-coverage-calculator). Prefer the printed sq ft/gallon line when Home Depot sells Behr by the US gallon.',
      },
    ],
  },
  {
    ...
    sections: [
      ...
      },
      {
        ...
        bullets: [
          ...
          'Use the [Behr paint coverage calculator](/paint-coverage-calculator) after deciding how much of the wall must be recoated',
        ],
      },
    ],
    faqs: [
