...
export const LANDING_EDITORIAL: Record<string, LandingEditorial> = {
  'how-much-paint-do-i-need': {
    ...
    sections: [
      ...
      {
        heading: 'Buy all Behr gallons from one dye lot',
        paragraphs: [
          'Open-concept walls and long hallways show colour shifts if you top up mid-project from a new tint batch. Measure once, run this calculator (or the [Behr paint coverage calculator](/paint-coverage-calculator) if you already know total sq ft), then buy every gallon before you roll.',
          'Keep the leftover sealed can for touch-ups — matching a dried wall from a later mix is harder than overbuying by a quart.',
        ],
      },
      {
        heading: 'Ceiling-only Behr gallon check',
        paragraphs: [
          'Painting the ceiling alone? Length × width is the area (12×12 = 144 sq ft). Two coats of Behr ceiling flat at ~350–400 sq ft/gallon usually lands under one gallon — buy 1 gallon so you have touch-up left.',
          'Prefer coverage-only math with the ceiling product’s label rate? Use the [Behr paint coverage calculator](/paint-coverage-calculator), then come back here if you also need wall gallons with waste.',
        ],
      },
    ],
  },
  ...
  'paint-coverage-calculator': {
    ...
    sections: [
      ...
      {
        heading: 'Per-litre labels → sq ft per gallon',
        paragraphs: [
          'Some Canadian cans list coverage in m²/L. Convert before you buy: 1 US gallon ≈ 3.785 L, and 1 m² ≈ 10.764 sq ft. Example: 10 m²/L ≈ 407 sq ft/gallon — enter that here, then round up for waste.',
          'Prefer the printed sq ft/gallon line when Home Depot sells Behr by the US gallon. After gallons print, confirm coats and waste on [how much Behr paint do I need](/how-much-paint-do-i-need).',
        ],
      },
      {
        heading: 'Two-coat planning without doubling guesswork',
        paragraphs: [
          'Set coats to 2 in this Behr paint coverage calculator when you will roll a full second coat — do not invent a “half rate.” Example: 384 sq ft walls × 2 ÷ 400 = 1.92 → buy 2 gallons on smooth primed drywall.',
          'Accent walls and powder rooms often land under one gallon after two coats; whole bedrooms usually need two. Prefer a shopping list with waste baked in? Use [how much Behr paint do I need](/how-much-paint-do-i-need).',
        ],
      },
      {
        heading: 'Hallways and stairwells — measure runs, not “rooms”',
        paragraphs: [
          'Hallways and stairwells rarely fit a single L×W room box. Add each wall run (length × height), include landings, and treat stair soffits separately if you paint them. Enter the total wall sq ft here with your Behr label rate.',
          'Buying tip: purchase all gallons in one trip so dye lots match on long continuous walls — confirm gallons with this coverage calculator before checkout.',
        ],
      },
      {
        heading: 'Garage and unfinished basement coverage',
        paragraphs: [
          'Unfinished drywall, block, and dusty garage walls absorb more paint than living-room drywall. Start closer to 250–300 sq ft/gallon even if the Behr Premium Plus label lists ~400 on ideal surfaces, then raise the rate only after a test patch.',
          'Prime porous substrates first, then re-run this calculator with the finish can’s Coverage line for topcoats only. For coats + waste as a store list, finish on [how much Behr paint do I need](/how-much-paint-do-i-need).',
        ],
      },
      {
        heading: 'Closets and pantries — small sq ft, still buy enough',
        paragraphs: [
          'Closets and pantries look tiny but still need two coats on every wall face you paint. Add width × height for each wall, skip shelving unless it gets paint, then enter total sq ft here with your Behr Coverage line.',
          'Quarts often win for a single closet; buy a gallon when you are matching an adjacent hallway colour so dye lots stay consistent — confirm with [how much Behr paint do I need](/how-much-paint-do-i-need) if coats + waste matter.',
        ],
      },
    ],
  },
