    ...
    <main id="main-content" className="max-w-3xl mx-auto px-4 sm:px-6 py-8 sm:py-12" role="main">
      ...
      <figure className="mb-8 rounded-2xl overflow-hidden border border-slate-200 dark:border-slate-800">
        <img
          ...
          alt={`${guide.title} — painting project photo`}
      ...
      {guide.toolPath && guide.toolLabel && (
        <div className="mb-8 p-4 rounded-xl border border-blue-200 dark:border-blue-900/50 bg-blue-50/50 dark:bg-blue-950/20">
          ...
          <Link to={guide.toolPath} className="text-blue-700 dark:text-blue-400 font-semibold hover:underline">
            {guide.toolLabel} →
          </Link>
        </div>
      )}
      ...
      <p className="text-xs text-slate-500 dark:text-slate-400 mt-8 leading-relaxed border-t border-slate-200 dark:border-slate-800 pt-6">
        {SITE_NAME} provides estimates for planning only — not professional painting advice. Verify quantities at your
        paint store.{' '}
