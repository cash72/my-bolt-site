...
export default function GuidesIndexPage() {
  usePageMeta({
    ...
    description:
      'Should you use primer? How to repair walls, patch drywall, prep for paint, and paint a room step-by-step. Plus coverage, wallpaper, and stain guides with free calculators.',
    path: '/guides',
  });
  ...
  return (
    <main id="main-content" className="max-w-5xl mx-auto px-4 sm:px-6 py-8 sm:py-12" role="main">
      ...
      <p className="text-slate-600 dark:text-slate-400 mb-8 max-w-2xl">
        Prep and how-to articles — primer, wall repair, painting steps — plus coverage calculators for paint,
        wallpaper, and stain on paint-calculator.ca.
      </p>
