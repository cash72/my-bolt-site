...
const HOMEPAGE_FAQ = [
  ...
  {
    q: 'How much Behr paint for a garage or unfinished basement?',
    a: 'Plan 250–300 sq ft/gallon on porous block or unfinished drywall — not the smooth-wall 400 label. Prime first, then confirm gallons in the [Behr paint coverage calculator](/paint-coverage-calculator).',
  },
  {
    q: 'How much Behr paint for a closet or pantry?',
    a: 'Measure each wall face; most reach-in closets are 40–80 sq ft. Two coats often need a quart to one gallon — confirm in the [Behr paint coverage calculator](/paint-coverage-calculator) with your can’s Coverage line.',
  },
] as const;

export default function HomePage() {
  usePageMeta({
    title: 'Free Behr Paint Coverage Calculator Canada — Gallons by Room',
    description:
      'Free Behr paint coverage calculator for Canada: room sq ft ÷ label sq ft/gal → gallons. 12×12 ≈ 2–3 gal at ~400 sq ft/gal. Walls, ceiling, fence, deck, cost.',
    path: '/',
  });
