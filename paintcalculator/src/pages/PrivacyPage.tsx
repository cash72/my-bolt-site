  ...
  return (
    <LegalPageLayout title="Privacy Policy">
      ...
      <p>
        ...
        our paint calculators and guides, and how advertising partners may use cookies when ads are enabled.
      </p>

      <h2 className="text-xl font-semibold text-slate-800 dark:text-slate-200">Information you enter in tools</h2>
      <p>
        Room dimensions, coats, and coverage settings you type into calculators are processed in your browser. We do not require an account and we do not intentionally store
