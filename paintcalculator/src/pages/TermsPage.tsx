...
export default function TermsPage() {
  usePageMeta({
    title: 'Terms of Use',
    description: `Read the ${SITE_NAME} terms covering calculator estimates, educational guides, acceptable use, warranties, and liability.`,
    path: '/terms',
  });
  ...
  return (
    <LegalPageLayout title="Terms of Use">
      ...
      <p>
        {SITE_NAME} offers free paint and wallpaper calculators for Canadian DIYers — gallons, coverage, rooms, ceilings, exteriors, and related how-to guides. Content is for general information and estimating only.
      </p>

      <h2 className="text-xl font-semibold text-slate-800 dark:text-slate-200">Not professional advice</h2>
      <p>
