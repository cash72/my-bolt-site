    ...
    sections: [
      ...
      },
      {
        ...
        paragraphs: [
          ...
          'Bitcoin does not close on weekends; volatility at 2 AM matters as much as midday. Refresh before large decisions. Before you send sats on-chain, check fee rates with the [Bitcoin fee calculator](/bitcoin-fee-calculator).',
        ],
      },
      {
