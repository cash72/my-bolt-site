...
export const LANDING_EDITORIAL: Record<string, LandingEditorial> = {
  ...
  'satoshi-to-usd': {
    ...
    sections: [
      ...
      {
        heading: 'Convert first, then decide whether to broadcast',
        paragraphs: [
          'Use this hub for the live USD label on any sat amount, then open the [Bitcoin fee calculator](/bitcoin-fee-calculator) before you hit send. If fee USD is more than a few percent of the stack, wait for a quieter mempool or use Lightning for small tips.',
          'Fixed checkpoints like [50k](/50000-satoshi-to-usd), [100k](/100000-satoshi-to-usd), and [1M sats](/1000000-satoshi-to-usd) make that fee-percent comparison faster to bookmark.',
        ],
      },
      {
