  ...
  const faqItems = useMemo(
    () => [
      ...
      },
      {
        ...
        answer:
          'For tips and small payments, Lightning fees are usually far cheaper than on-chain. Use on-chain for cold-storage moves and exchange withdrawals when you need settlement finality. See [Lightning Network basics](/guides/lightning-network-basics) and convert fee sats on [Satoshi to USD](/satoshi-to-usd).',
      },
      {
