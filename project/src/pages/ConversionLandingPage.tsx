    ...
    if (isSatsToFiat) {
      return [
        ...
        },
        {
          ...
          answer:
            'No — the calculator shows spot conversion only. Trading fees, card premiums, and on-chain withdrawal fees reduce what you actually receive. Estimate mempool cost with the [Bitcoin fee calculator](/bitcoin-fee-calculator) before withdrawing.',
        },
      ];
    }
    if (isFiatToSats) {
