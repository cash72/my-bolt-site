...
export const P0_INDEX_BY_DIR = {
  ...
  hvaccalculator: {
    ...
    paths: [
      { path: '/btu-calculator/', note: 'how many BTU per square foot money page' },
      { path: '/mini-split-for-rv/', note: 'what size mini-split for an RV' },
      { path: '/window-ac-calculator/', note: 'what size window AC' },
  ...
  flooringboxcalculator: {
    ...
    paths: [
      { path: '/how-many-flooring-boxes/', note: 'how many boxes money page' },
      { path: '/laminate-flooring-calculator/', note: 'laminate box counts' },
      { path: '/flooring-cost-estimator/', note: 'how much does flooring cost' },
      { path: '/flooring-square-footage-calculator/', note: 'how much flooring do I need' },
      { path: '/', note: 'hub title aligned to box-count query' },
      { path: '/guides/diy-flooring-installation-roadmap/' },
  ...
  paintcalculator: {
    ...
    paths: [
      { path: '/', note: 'multi-brand homepage + DIY starter cards' },
      { path: '/first-paint-job/', note: 'beginner hub: gallons, roller, brush, tape', isNew: true },
      { path: '/canadian-paint-coverage/', note: 'brand coverage chart', isNew: true },
      { path: '/how-much-paint-do-i-need/' },
      { path: '/paint-coverage-calculator/' },
      { path: '/benjamin-moore-paint-calculator/', isNew: true },
      { path: '/sherwin-williams-paint-calculator/', isNew: true },
      { path: '/cloverdale-paint-calculator/', isNew: true },
      { path: '/dulux-paint-calculator/', isNew: true },
      { path: '/sico-paint-calculator/', isNew: true },
      { path: '/beauti-tone-paint-calculator/', isNew: true },
      { path: '/cil-paint-calculator/', isNew: true },
      { path: '/valspar-paint-calculator/', isNew: true },
      { path: '/guides/how-to-choose-a-paint-roller/', isNew: true },
      { path: '/guides/how-to-choose-a-paint-brush/', isNew: true },
      { path: '/guides/painters-tape-vs-drop-cloths/', isNew: true },
